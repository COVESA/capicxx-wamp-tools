...
void ExampleInterfaceStubImpl::method1(
		const std::shared_ptr<CommonAPI::ClientId> _client, std::string _arg1,
...
void ExampleInterfaceStubImpl::method2(
		const std::shared_ptr<CommonAPI::ClientId> _client, bool _arg1,
		method2Reply_t _reply) {
	std::cout << "ExampleInterfaceStubImpl::method2 called with arg1='" << _arg1
			<< "'" << std::endl;
...
void ExampleInterfaceStubImpl::method3(
		...
		ExampleInterface::MyEnum _arg1, method3Reply_t _reply) {
	std::cout << "ExampleInterfaceStubImpl::method3 called with arg1='" << _arg1
			<< "'" << std::endl;

	ExampleInterface::MyEnum ret1;
	switch (_arg1) {
	case ExampleInterface::MyEnum::ENUM1:
		ret1 = ExampleInterface::MyEnum::ENUM2;
		break;
	case ExampleInterface::MyEnum::ENUM2:
		ret1 = ExampleInterface::MyEnum::ENUM3;
		break;
	case ExampleInterface::MyEnum::ENUM3:
		ret1 = ExampleInterface::MyEnum::ENUM4;
		break;
	case ExampleInterface::MyEnum::ENUM4:
		ret1 = ExampleInterface::MyEnum::ENUM1;
		break;
	}
	_reply(ret1);
}
...
void ExampleInterfaceStubImpl::method4(
		const std::shared_ptr<CommonAPI::ClientId> _client,
		ExampleInterface::MyStruct1 _arg1, method4Reply_t _reply) {
...
void ExampleInterfaceStubImpl::method5(
		const std::shared_ptr<CommonAPI::ClientId> _client,
		ExampleInterface::MyArray1 _arg1, method5Reply_t _reply) {
...
void ExampleInterfaceStubImpl::method6(
		const std::shared_ptr<CommonAPI::ClientId> _client,
		std::vector<uint64_t> _arg1, method6Reply_t _reply) {
...
void ExampleInterfaceStubImpl::method7(
		const std::shared_ptr<CommonAPI::ClientId> _client,
		std::vector<ExampleInterface::MyStruct1> _arg1, method7Reply_t _reply) {
...
void ExampleInterfaceStubImpl::method8(
		const std::shared_ptr<CommonAPI::ClientId> _client,
		ExampleInterface::MyStruct2 _arg1, method8Reply_t _reply) {
...
void ExampleInterfaceStubImpl::method9(
		const std::shared_ptr<CommonAPI::ClientId> _client,
		ExampleInterface::MyUnion1 _arg1, method9Reply_t _reply) {
