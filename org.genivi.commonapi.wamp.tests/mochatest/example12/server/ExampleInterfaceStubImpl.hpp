...
public:
    ...
    virtual void method4(const std::shared_ptr<CommonAPI::ClientId> _client, ExampleInterface::MyStruct1 _arg1, method4Reply_t _reply);
    ...
    virtual void method9(const std::shared_ptr<CommonAPI::ClientId> _client, ExampleInterface::MyUnion1 _arg1, method9Reply_t _reply);
